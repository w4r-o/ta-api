    ...
    <>
      ...
      <main className="w-screen min-h-screen flex flex-col items-center pt-32 px-10 md:px-32 lg:px-60 bg-[url('/background.png')] bg-cover bg-no-repeat bg-center">
        <header className="w-full flex flex-col items-center">
          ...
          <div className="w-full flex flex-row items-center justify-evenly mt-7">
            <input
              ...
              className="bg-green-transparent text-white focus:outline-none w-1/3 px-6 py-3 placeholder-white-transparent rounded-full ring-2 ring-green-light shadow-[0px_0px_8px_3px_rgba(219,231,219,0.6)] duration-300 ease-in-out hover:shadow-[0px_0px_20px_3px_rgba(219,231,219,0.7)]"
            />
            <input
              type="password"
            ...
            <button
              onClick={request}
              className="bg-green-light w-1/4 text-green-dark text-center font-bold px-6 py-3 rounded-full ring-2 ring-green-light shadow-[0px_0px_8px_3px_rgba(219,231,219,0.6)] hover:scale-105 duration-300 ease-in-out hover:shadow-[0px_0px_20px_3px_rgba(219,231,219,0.7)]"
            >
              Get Marks!
            </button>
          </div>
        ...
        <section className="w-full flex flex-col items-center mt-20">
          ...
          <p className="text-base text-center font-normal text-white mt-2">
          ...
          <h3 className="text-xl font-bold text-white mt-7">Request</h3>
          <p className="text-base text-center font-normal text-white mt-2">
          ...
          <div className="w-full p-2 mt-7 ring-2 ring-green-light shadow-[0px_0px_8px_3px_rgba(219,231,219,0.6)] bg-green-transparent rounded-3xl">
            <div className="w-full max-h-64 overflow-y-scroll overflow-x-hidden px-5 py-3">
              <pre className="text-white text-sm font-normal w-full">
